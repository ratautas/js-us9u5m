!(function () {
  ...
  function f() {
    ...
    return !(
      e &&
      ((t = e), t.offsetWidth || t.offsetHeight || t.getClientRects().length)
    );
  }
  function g() {
    var t = window.location.hash;
    return (
      '' === t || (-1 === t.indexOf('#!/c/0/') && -1 === t.indexOf('#!//c/0/'))
    );
  }
  function w(t) {
  ...
  function y(t, o) {
    ...
    e &&
      ...
      t.addEventListener('touchmove', function (t) {
        (r = t.changedTouches[0].clientX - n),
          (a = t.changedTouches[0].clientY - i);
      }),
  ...
  (window.ec = window.ec || {}),
    ...
    (t = function () {
      if (
        !0 === (window.ec.storefront.staticPages.staticStorefrontEnabled || !1)
      )
        if (
          ...
          if (i && document.querySelector('#' + i)) {
            if (
              (-1 !== window.location.hash.indexOf('#!/c/0') &&
                document.querySelector('#' + o).scrollIntoView(!0),
              'ontouchstart' in window &&
                ((e = !0), document.body.classList.add('touchable')),
              ...
              if (void 0 === ec.storefront.staticPages.lazyLoading.scriptJsLink)
                return void (
                  console &&
                  console.warn(
                    'Storefront lazy loading is enabled, but no scriptJsLink is provided'
                  )
                );
              if (
                void 0 ===
                ec.storefront.staticPages.lazyLoading.xProductBrowserArguments
              )
                return void (
                  console &&
                  console.warn(
                    'Storefront lazy loading is enabled, but no xProductBrowser arguments are provided'
                  )
                );
              b(!0);
              var t = !0;
              function d() {
                void 0 === t
                  ? console &&
                    console.warn(
                      'Unable to fetch script.js outside of lazy loading mode'
                    )
                  : (b(!1), w(P));
              }
              var P = function () {
                xProductBrowser.apply(
                  this,
                  ec.storefront.staticPages.lazyLoading.xProductBrowserArguments
                ),
                  E();
            ...
            _ && (s = _);
            var L =
              ec.storefront.staticPages.autoSwitchStaticToDynamicWhenReady;
            if (
              ((a = L || c),
              ec.storefront.staticPages.initialCategoryOffset &&
                (u = ec.storefront.staticPages.initialCategoryOffset),
              m(),
              (function () {
                var t = l('#' + o + ' .' + n);
                t && (t.style.opacity = 1);
            ...
            !(function () {
              function t(t, e) {
                for (
                  var o = document.querySelectorAll(t), n = 0;
                  n < o.length;
                  n++
                )
                  e(o[n]);
              ...
              e &&
                ...
                t(
                  '#' + o + ' .grid__sort .grid-sort__item--filter',
                  function (t) {
                    y(t, function () {
                      v(function () {
                ...
                t(
                  '#' +
                    o +
                    ' .grid-product:not(.grid-product--view-all) a:not(.open-external-url)',
                  function (t) {
                ...
                t(
                  '#' +
                    o +
                    ' .grid-product:not(.grid-product--view-all) .grid-product__wrap[data-product-id]',
                  function (t) {
                    var e = t.getAttribute('data-product-id');
                    y(t, p('product', { id: e }));
                  }
                      ...
                      var o = (function () {
                        ...
                        try {
                          var t = document.querySelector(
                            '#' + i + ' .grid-category--loading'
                          );
                          if (null != t) return !1;
                          var e = document.querySelector(
                            '#' + i + ' .grid-product--loading'
                          );
                          if (null != e) return !1;
                        } catch (t) {}
                        return !0;
      ...
      function k() {
        return (
          !!window.ecwidMessages && Object.keys(window.ecwidMessages).length > 0
        );
      }
    }),
    (
          ...
          if (void 0 !== ec.storefront.staticPages.lazyLoading.scriptJsLink)
            if (
              ...
              var t = document.getElementById(
                ec.storefront.staticPages.staticContainerID
              );
              if (g())
                (t.style.height = ''),
                  (t.style.maxHeight = ''),
              ...
              console &&
                console.warn(
                  'No xProductBrowser arguments are provided to switch in dynamic mode'
                );
          else
            console &&
              console.warn(
                'No scriptJsLink is provided to switch in dynamic mode'
              );
        else
          console &&
            console.warn(
              'Storefront lazy loading is not enabled to switch in dynamic mode'
            );
      });
})();
